...
import alls.tech.gr.bridge.BridgeClient
import alls.tech.gr.core.Config
import alls.tech.gr.core.InstanceManager
import alls.tech.gr.core.Logger
import alls.tech.gr.core.LogSource
import alls.tech.gr.core.TaskScheduler
import alls.tech.gr.utils.TaskManager
import alls.tech.gr.core.Utils.handleImports
import alls.tech.gr.core.http.Client
import alls.tech.gr.core.http.Interceptor
import alls.tech.gr.persistence.GPDatabase
import alls.tech.gr.utils.HookManager
import alls.tech.gr.utils.PCHIP
...
object GR {
    ...
    private val splineDataEndpoint = "https://alls.tech/s%E2%88%9E"//"https://raw.githubusercontent.com/R0rt1z2/GrindrPlus/refs/heads/master/spline.json"
