package alls.tech.gr.persistence.mappers
...
fun AlbumEntity.toGrindrAlbum(dbContent: List<AlbumContentEntity>): Any {
    try {
        val albumConstructor = GR.loadClass(ALBUM_CLASS).constructors.first()
        ...
        try {
            val albumClass = GR.loadClass(ALBUM_CLASS)
...
fun AlbumEntity.toGrindrAlbumBrief(dbContent: AlbumContentEntity): Any {
    try {
        val albumBriefConstructor = GR.loadClass(ALBUM_BRIEF_CLASS).constructors.first()
        ...
        try {
            val albumBriefClass = GR.loadClass(ALBUM_BRIEF_CLASS)
...
fun AlbumContentEntity.toGrindrAlbumContent(): Any {
    try {
        val albumContentConstructor = GR.loadClass(ALBUM_CONTENT_CLASS).constructors.first()
        ...
        try {
            val albumContentClass = GR.loadClass(ALBUM_CONTENT_CLASS)
