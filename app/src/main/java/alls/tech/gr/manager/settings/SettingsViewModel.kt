package alls.tech.gr.manager.settings
...
import alls.tech.gr.manager.settings.SettingsUtils.testMapsApiKey
import alls.tech.gr.manager.utils.AppIconManager
            ...
            try {
                ...
                val managerSettings = mutableListOf<Setting>(
                    TextSettingWithButtons(
                        id = "maps_api_key",
                        title = "Maps API Key",
                        description = "Use a custom Maps API Key when using GR with LSPatch",
                    ...
                    TextSetting(
                        ...
                        description = "Use a custom manifest URL when using GR with LSPatch",
