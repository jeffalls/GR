...
import alls.tech.gr.bridge.NotificationActionReceiver
...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            LaunchedEffect(Unit) {
                GR.bridgeClient = BridgeClient(this@MainActivity)
                GR.bridgeClient.connectAsync { connected ->
