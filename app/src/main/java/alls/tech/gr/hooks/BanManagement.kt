...
import alls.tech.gr.GR.loadClass
import alls.tech.gr.GR.restartGrindr
import alls.tech.gr.core.Config
import alls.tech.gr.core.Logger
import alls.tech.gr.core.constants.GrindrApiError
import alls.tech.gr.core.constants.GrindrApiError.Companion.getErrorDescription
...
import alls.tech.gr.utils.RetrofitUtils.getFailValue
...
class BanManagement : Hook(
    ...
    private fun createBanDetailsDialog(context: Context, bannedInfo: JSONObject) {
        ...
        val dialog = android.app.AlertDialog.Builder(GR.currentActivity)
