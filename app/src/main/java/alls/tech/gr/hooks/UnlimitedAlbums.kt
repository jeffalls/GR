...
import alls.tech.gr.persistence.mappers.asAlbumBriefToAlbumEntity
import alls.tech.gr.persistence.mappers.asAlbumToAlbumEntity
import alls.tech.gr.persistence.mappers.toAlbumContentEntity
import alls.tech.gr.persistence.mappers.toGrindrAlbum
import alls.tech.gr.persistence.mappers.toGrindrAlbumBrief
import alls.tech.gr.persistence.mappers.toGrindrAlbumContent
import alls.tech.gr.persistence.mappers.toGrindrAlbumWithoutContent
...
import alls.tech.gr.utils.RetrofitUtils.SUCCESS_VALUE_NAME
import alls.tech.gr.utils.RetrofitUtils.createSuccess
import alls.tech.gr.utils.RetrofitUtils.getSuccessValue
import alls.tech.gr.utils.RetrofitUtils.isFail
import alls.tech.gr.utils.RetrofitUtils.isGET
import alls.tech.gr.utils.RetrofitUtils.isPUT
import alls.tech.gr.utils.RetrofitUtils.isSuccess
import alls.tech.gr.utils.hook
import alls.tech.gr.utils.hookConstructor
import alls.tech.gr.utils.withSuspendResult
    ...
    private fun handleGetAlbum(args: Array<Any?>, result: Any) =
        withSuspendResult(args, result) { args, result ->
            ...
            try {
                ...
                Logger.writeRaw(e.stackTraceToString())
                GR.showToast(Toast.LENGTH_LONG, "Failed to load album")
                val modifiedResult = fetchAlbumFromDatabase(albumId, result)
                return@withSuspendResult modifiedResult
            }
        }
